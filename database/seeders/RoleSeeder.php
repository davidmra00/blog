...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name'=>'admin.home',
                            'description'=>'Ver panel administracion'])->syncRoles([$role1,$role2]);

        Permission::create(['name'=>'admin.users.index',
                            'description'=>'Ver lista usuarios'])->syncRoles([$role1]);
        ...
        Permission::create(['name'=>'admin.roles.index',
                            'description'=>'Ver lista roles'])->syncRoles([$role1]);
        ...
        Permission::create(['name'=>'admin.tags.index',
                            'description'=>'Ver lista etiquetas'])->syncRoles([$role1,$role2]);
        ...
        Permission::create(['name'=>'admin.posts.index',
                            'description'=>'Ver lista posts'])->syncRoles([$role1,$role2]);
